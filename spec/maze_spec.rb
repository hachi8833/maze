...
describe :Maze do
  ...
  context "インスタンス作成" do
    ...
    it "配列が正常に作成できる" do
      expect(@maze.ary).to eq [[nil, nil, nil, nil, nil, nil, nil], [nil, 1, 1, 1, 1, 1, nil], [nil, 1, nil, nil, nil, 1, nil], [nil, 1, nil, nil, nil, 1, nil], [nil, 1, nil, nil, nil, 1, nil], [nil, 1, 1, 1, 1, 1, nil], [nil, nil, nil, nil, nil, nil, nil]] 
    end
  end
  ...
  context "メソッドの単体テスト" do
    ...
    it :prepare_ary do
      ...
      expect(@maze.ary).to eq [[nil, nil, nil], [nil, 1, nil], [nil, nil, nil]]
    end
